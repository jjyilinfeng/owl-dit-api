...
public interface DitMapper {
     ...
     * @return 查询信息
     */
    List<Map<String, Object>> queryAllDit(@Param("userName")String userName,@Param("limit")int limit);
     ...
     * @return 查询信息
     */
    int queryAllDitCount(@Param("userName")String userName);
     ...
     * @return 图片的Uuid
     */
    List<Map<String, String>> queryDitImgByDitUuid(@Param("ditUuid")String ditUuid);
     ...
     * @return 改变的条数
     */
    int deleteDitComment(@Param("ditCommentUserName")String ditCommentUserName, @Param("ditUuid")String ditUuid);
     ...
     * @return 改变的条数
     */
    int deleteDitPraise(@Param("ditPraiseUserName")String ditPraiseUserName,@Param("ditUuid")String ditUuid);
     ...
     * @return 改变的条数
     */
    int deleteDitByUuid(@Param("ditUuid")String ditUuid);
