...
public interface IndexService {
     ...
     * @return 关注数
     */
    int queryUserConcernCountByUserName(String userName);
     ...
     * @return 粉丝数
     */
    int queryUserFanCountByUserName(String userName);
     ...
     * @return dits数
     */
    int queryUserDitsByUserName(String userName);
     ...
     * @return 匹配值的个数
     */
    int queryUserConcernWhether(String userConcernName, String userByConcernName);
     ...
     * @return 搜索数据
     */
    List<UserInfo> searchUser(@Param("searchWords")String searchWords);
     ...
     * @return 搜索数据
     */
    List<Map<String, Object>> searchDit(@Param("searchWords")String searchWords);
     ...
     * @return 搜索数据
     */
    List<User> searchArticle(@Param("searchWords")String searchWords);
     ...
     * @return 获赞数
     */
    int queryPraiseCountByUserName(String userName);
     ...
     * @return 文章数
     */
    int queryArticleCountByUserName(String userName);
